...
func TestPingversion1(t *testing.T) {
...
func TestPing(t *testing.T) {
	// Create  new instance of our application struct. For now, this just
	...
	// We can then chunk the value of the response status code and body using
...
func TestPingVersion2(t *testing.T) {
...
func TestSnippetCreate(t *testing.T) {
	...
	t.Run("Authenticated", func(t *testing.T) {
		// Make a get request to the login page to extract the CSRF token
		_, _, body := ts.get(t, "/user/login")
		csrfToken := extractCSRFToken(t, body)

		// Make a post request to the login page to be authenticated
		form := url.Values{}
		...
		// Make a request to the create snippet page
